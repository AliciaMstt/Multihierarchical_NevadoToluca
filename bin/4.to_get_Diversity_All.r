...
# Sourse to scripts Diptera and data
...
# Sourse to scripts Collembola and data
...
# Sourse to scripts Arachnida and data
...
# Sourse to scripts Hemiptera and data
...
# Sourse to scripts Hymenoptera and data
...
# Sourse to scripts Coleoptera and data
...
# Sourse to scripts Myriapoda and data
...
# Sourse to scripts Lepidoptera and data

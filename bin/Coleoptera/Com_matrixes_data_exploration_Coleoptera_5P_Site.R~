...
#'**Community diversity and composition at the 5% Clustering level of the Coleoptera order**'#
...
s2_raw_Coleoptera_limite0.05[,1:49]->data0.05
rowSums(data0.05)
...
t_s2_f4_Coleoptera_limite0.05[1:49,]->community_Coleoptera_limite0.05 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.05".
...
write.table (community_Coleoptera0.05, file="../genetic/Data_out/Coleoptera/Coleoptera5P/community_Coleoptera0.05.txt") #'this is necessary for the format, not able to solve in other way
...
dim(community_Coleoptera0.05)
community_Coleoptera0.05[which(str_extract (row.names(community_Coleoptera0.05), "_NTO_") %in% "_NTO_"),]->community_Coleoptera_Site0.05
dim(community_Coleoptera_Site0.05)
community_Coleoptera_Site0.05[,which(colSums(community_Coleoptera_Site0.05)!=0)]->community_Coleoptera_Site0.05 #'to remove no data colums
dim(community_Coleoptera_Site0.05)
...
#BY SITE
#'Generating a general table with names and habitat parameters
row.names(community_Coleoptera_Site0.05)->sample_names_Mountain1_0.05
...
general_sample_Mountain1Site0.05
write.table(general_sample_Mountain1Site0.05, file="../genetic/Data_out/Coleoptera/Coleoptera5P/general_sample_Mountain1Site0.05.txt") #'this is the only way I found to be able to work later
...
#'*Coleoptera*
as.matrix(community_Coleoptera_Site0.05)->community_Coleoptera_Site0.05
row.names(community_Coleoptera_Site0.05)->sample_names_Site0.05
dim(community_Coleoptera_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Coleoptera_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_Site0.05 #'summatory by rows
...
#BY SITE
write.table(richness_Site0.05, file="../genetic/Data_out/Coleoptera/Coleoptera5P/richness_Site0.05_Coleoptera.txt") #'this is the only way I found to be able to work later
...
barplot(richness_Site0.05$sample_richness_Site0.05,col=richness_Site0.05$Mountain1Site,names.arg= richness_Site0.05$sample_names_Site0.05,las=2,cex.names=0.5, ylab="richness_Site0.05", main="H richness_SiteColeoptera_0.05")
...
##'Singletons by SITE
#'summatory by rows
colnames(community_Coleoptera_Site0.05)->h_names_Site0.05
dim (community_Coleoptera_Site0.05)->dims_Site0.05
.colSums (community_Coleoptera_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->h_ocurrence_Site0.05 #'summatory by cols
...
write.table(h_ocurrence_Site0.05, file="../genetic/Data_out/Coleoptera/Coleoptera5P/h_ocurrence_Site0.05_Coleoptera.txt") #'this is the only way I found to be able to work later
read.table("../genetic/Data_out/Coleoptera/Coleoptera5P/h_ocurrence_Site0.05_Coleoptera.txt",header=TRUE)->h_ocurrence_Site0.05
...
which(h_ocurrence_Site0.05$h_ocurrence_Site0.05>2)->more2_Site
more2_Site
length(more2_Site)
length(more2_Site)/length(h_ocurrence_Site0.05$h_ocurrence_Site0.05)*100

#'number of singletons by SITE
#community_Coleoptera_Site0.05
#singletons
community_Coleoptera_Site0.05[,singletons_Site0.05]->community_Coleoptera_singletons_Site0.05
row.names(community_Coleoptera_singletons_Site0.05)->sample_names_Site0.05
dim (community_Coleoptera_singletons_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Coleoptera_singletons_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_singletons_Site0.05 #'summatory by rows
...
specpool(community_Coleoptera_Site0.05)->specpool_Site
...
plot (MDSbetasim0.05, main="Coleoptera_Site_0.05") 
x<- MDSbetasim0.05$points[,1]
y<- MDSbetasim0.05$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Coleoptera_Site0.05))

plot (MDSbetasim0.05, main="Coleoptera_Site_0.05")
with(general_sample_Mountain1Site0.05,ordispider(MDSbetasim0.05, Site, label=T, col="blue"))

############################
#By SITES quitar 122, 108
...
general_sample_Mountain1Site0.05[-which(general_sample_Mountain1Site0.05$sample_names %in% c("CON_NTO_AAB_122ACON12", "CON_NTO_AAB_108ACON21")),]->general_sample_sinoutlayer
...
plot (MDSbetasim0.05, main="Coleoptera_Site_0.05")
with(general_sample_sinoutlayer,ordispider(MDSbetasim0.05, Site, label=T, col="blue"))
#plot (MDSbetasim0.05, main="Coleoptera_Site")
#with(general_sample_sinoutlayer,ordispider(MDSbetasim0.05, ID, label=T, col="red"))
plot (MDSbetasim0.05, main="Coleoptera_Site0.05")
x<- MDSbetasim0.05$points[,1]
y<- MDSbetasim0.05$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Coleoptera_sinoutlayer0.05))

plot (MDSbetasim0.05, xlim=c(-0.5, 0.5), ylim=c(-0.5, 0.5), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Coleoptera_Site0.05")
with(general_sample_sinoutlayer,ordispider(MDSbetasim0.05, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

#Anosim
anosim(beta.pair$beta.sim, general_sample_sinoutlayer$Site, permutations=999)

plot (MDSbetasim0.05, xlim=c(-0.5, 0.5), ylim=c(-0.5, 0.5), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Coleoptera_Site0.05")
with(general_sample_sinoutlayer,ordispider(MDSbetasim0.05, Site, cex.lab=1, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0"), lwd=4.5))

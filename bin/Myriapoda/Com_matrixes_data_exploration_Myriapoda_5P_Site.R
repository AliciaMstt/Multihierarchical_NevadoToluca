...
plot (MDSbetasim, main="Myriapoda_Site_0.05") 
x<- MDSbetasim$points[,1]
y<- MDSbetasim$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Myriapoda_Site0.05))

plot (MDSbetasim, main="Myriapoda_Site_0.05")
with(general_sample_Mountain1Site_0.05,ordispider(MDSbetasim, Site, label=T, col="blue"))

plot (MDSbetasim, xlim=c(-0.5, 0.5), ylim=c(-0.5, 0.5), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Myriapoda_Site_0.05")
with(general_sample_Mountain1Site_0.05,ordispider(MDSbetasim, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

plot (MDSbetasim, xlim=c(-0.5, 0.5), ylim=c(-0.5, 0.5), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Myriapoda_Site_0.05")
with(general_sample_Mountain1Site_0.05,ordispider(MDSbetasim, Site, cex.lab=1, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0"), lwd=4.5))

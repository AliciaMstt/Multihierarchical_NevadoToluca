...
#BY SITE
write.table(richness_Site0.03, file="richness_Site_Lepidoptera.txt") #'this is the only way I found to be able to work later
read.table("richness_Site_Lepidoptera.txt",header=TRUE)->richness_Site0.03

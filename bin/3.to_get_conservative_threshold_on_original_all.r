...
s2_raw_all_Arachnida[,c(1:52)]->s2_raw_Arachnida
...
s2_f4_with_abundance_Arachnida[,2:52]->data_Arachnida
...
##**remove additional columns and leave only names (of haplotipes), samples and taxa**
s2_raw_all_Coleoptera[,c(1:50)]->s2_raw_Coleoptera
...
##**checking if there is any row with no presence**
s2_f4_with_abundance_Coleoptera[,2:50]->data_Coleoptera
...
##**open table with names including Region and habitat parameters**
s2_raw_all_Collembola <- read.table("../genetic/Data_in/Collembola/5allele_table_4aCollembola1061YLimEsp.txt",sep = ",", header=TRUE)
dim(s2_raw_all_Collembola)

##**remove additional columns and leave only names (of haplotipes), samples and taxa**
s2_raw_all_Collembola[,c(1:52)]->s2_raw_Collembola
...
##**checking if there is any row with no presence**
s2_f4_with_abundance_Collembola[,2:52]->data_Collembola
...
##**open table with names including Region and habitat parameters**
s2_raw_all_Diptera <- read.table("../genetic/Data_in/Diptera/8allele_table_7Diptera2031YLimiteEspecies.txt", sep = ",", header=TRUE)
dim(s2_raw_all_Diptera)

##**remove additional columns and leave only names (of haplotipes), samples and taxa**
s2_raw_all_Diptera[,c(1:52)]->s2_raw_Diptera
...
##**checking if there is any row with no presence**
s2_f4_with_abundance_Diptera[,2:52]->data_Diptera
...
##**open table with names including Region and habitat parameters**
s2_raw_all_Hemiptera <- read.table("../genetic/Data_in/Hemiptera/10allele_table_10ParaneopteraHemiptera246YLimiteEspecie.txt", sep = ",", header=TRUE)
dim(s2_raw_all_Hemiptera)

##**remove additional columns and leave only names (of haplotipes), samples and taxa**
s2_raw_all_Hemiptera[,c(1:52)]->s2_raw_Hemiptera
...
##**checking if there is any row with no presence**
s2_f4_with_abundance_Hemiptera[,2:52]->data_Hemiptera
...
##**open table with names including Region and habitat parameters**
s2_raw_all_Hymenoptera <- read.table("../genetic/Data_in/Hymenoptera/9allele_table_8Hymenoptera227YLimitesEspecies.txt",sep = ",", header=TRUE)
dim(s2_raw_all_Hymenoptera)

##**remove additional columns and leave only names (of haplotipes), samples and taxa**
s2_raw_all_Hymenoptera[,c(1:51)]->s2_raw_Hymenoptera
...
##**checking if there is any row with no presence**
s2_f4_with_abundance_Hymenoptera[,2:51]->data_Hymenoptera
...
#**to_get_conservative_threshold_on_original_table_Lepidoptera**

##**open table with names including Region and habitat parameters**
s2_raw_all_Lepidoptera <- read.table("../genetic/Data_in/Lepidoptera/6allele_table_5Lepidoptera60YLimEsp.txt",sep = ",", header=TRUE)
dim(s2_raw_all_Lepidoptera)

##**remove additional columns and leave only names (of haplotipes), samples and taxa**
s2_raw_all_Lepidoptera[,c(1:38)]->s2_raw_Lepidoptera
dim(s2_raw_Lepidoptera) #'51 samples = 51 plus 1 neg (the second neg from DOM_REPS is not there because all 0)
colnames(s2_raw_Lepidoptera)

##**delete the ocurrences with less than 4 reads by library (same criteria than denoising)**
s2_raw_Lepidoptera->s2_f4_with_abundance_Lepidoptera 
s2_f4_with_abundance_Lepidoptera[s2_f4_with_abundance_Lepidoptera<4]<-0  #'2 warning corresponding wiht the columms of the names, taxa

##**checking if there is any row with no presence**
s2_f4_with_abundance_Lepidoptera[,2:38]->data_Lepidoptera
rowSums(data_Lepidoptera)
length(which(rowSums(data_Lepidoptera)!=0))
length(which(rowSums(data_Lepidoptera)==0))

##**generating subtables for Acari, Lepidoptera, Coleoptera**
###s2_f4_with_abundance[which(s2_f4_with_abundance$taxa == "Acari"),]->s2_f4_Acari 
###s2_f4_Acari[,1:50]->s2_f4_Acari #'remove taxa col
###dim(s2_f4_Acari)

###s2_f4_with_abundance[which(s2_f4_with_abundance$taxa == "Lepidoptera"),]->s2_f4_Lepidoptera 
###s2_f4_Lepidoptera[,1:50]->s2_f4_Lepidoptera #'remove taxonomy
###dim(s2_f4_Lepidoptera)

###s2_f4_with_abundance[which(s2_f4_with_abundance$taxa == "Coleoptera"),]->s2_f4_Coleoptera 
###s2_f4_Coleoptera[,1:50]->s2_f4_Coleoptera #'remove taxonomy
###dim(s2_f4_Coleoptera)

colSums(s2_f4_with_abundance_Lepidoptera[,-1])
###colSums(s2_f4_Lepidoptera[,-1])
###colSums(s2_f4_Coleoptera[,-1])

#**Lepidoptera**
##Filtrado 1% por Biblioteca

rownames(s2_f4_with_abundance_Lepidoptera)<-s2_f4_with_abundance_Lepidoptera[,1]
s2_f4_with_abundance_Lepidoptera[,-1]->s2_f4_Lepidoptera_limpia

colSums(s2_f4_Lepidoptera_limpia)

  for (i in 1:length(colnames(s2_f4_Lepidoptera_limpia)))
  {
   0.01*(sum(s2_f4_Lepidoptera_limpia[,i]))->lim_Lepidoptera
    s2_f4_Lepidoptera_limpia[,i][s2_f4_Lepidoptera_limpia[i]<lim_Lepidoptera]<-0
     }

colSums(s2_f4_Lepidoptera_limpia)

deleted_Lepidoptera<-which(rowSums(s2_f4_Lepidoptera_limpia)==0)
maintained_Lepidoptera<-which(rowSums(s2_f4_Lepidoptera_limpia)!=0)

##**Generating a table with 0 and 1 for deleted and maintained**   
names(deleted_Lepidoptera)->deleted_Lepidoptera
rep(0,length(deleted_Lepidoptera))->haplo_deleted_Lepidoptera

dim(deleted_Lepidoptera)<-c(length(deleted_Lepidoptera),1)
dim(haplo_deleted_Lepidoptera)<-c(length(haplo_deleted_Lepidoptera),1)
cbind (deleted_Lepidoptera, haplo_deleted_Lepidoptera)->haplo_deleted_Lepidoptera

names(maintained_Lepidoptera)->maintained_Lepidoptera  
rep(1,length(maintained_Lepidoptera))->haplo_maintained_Lepidoptera

dim(maintained_Lepidoptera)<-c(length(maintained_Lepidoptera),1)
dim(haplo_maintained_Lepidoptera)<-c(length(haplo_maintained_Lepidoptera),1)
cbind (maintained_Lepidoptera, haplo_maintained_Lepidoptera)->haplo_maintained_Lepidoptera

rbind(haplo_deleted_Lepidoptera,haplo_maintained_Lepidoptera)->conservative_threshold_Lepidoptera
table(conservative_threshold_Lepidoptera[,2])

rbind(conservative_threshold_Lepidoptera)->conservative_threshold_all_Lepidoptera

##**Combining conservative threshold info with intial table**
s2_raw_all_Lepidoptera[order(s2_raw_all_Lepidoptera[,1]),]->s2_raw_all_ord_Lepidoptera
conservative_threshold_all_Lepidoptera[order(conservative_threshold_all_Lepidoptera[,1]),]->conservative_threshold_all_ord_Lepidoptera
colnames(conservative_threshold_all_ord_Lepidoptera)<-c("haplo_names_conservative_threshold_Lepidoptera","conservative_threshold_Lepidoptera")

cbind(s2_raw_all_ord_Lepidoptera,conservative_threshold_all_ord_Lepidoptera)->s2_raw_all_Lepidoptera_threshold
...
##**open table with names including Region and habitat parameters**
s2_raw_all_Myriapoda <- read.table("../genetic/Data_in/Myriapoda/4allele_table_3Myriapoda60YLimEsp.txt",sep = ",", header=TRUE)
dim(s2_raw_all_Myriapoda)

##**remove additional columns and leave only names (of haplotipes), samples and taxa**
s2_raw_all_Myriapoda[,c(1:29)]->s2_raw_Myriapoda
...
##**checking if there is any row with no presence**
s2_f4_with_abundance_Myriapoda[,2:29]->data_Myriapoda

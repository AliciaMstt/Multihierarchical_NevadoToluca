...
#**Community diversity and composition at the 3% Clustering level of the Lepidoptera order**
...
data.frame()->s2_raw_Lepidoptera_limite0.03
...
for (i in 1:length(unique (s2_raw_threshold$limite0.03)))
{
  ...
  subcom_level_names0.03[,c(2:38)]->subcom_level0.03  #delete names, level and also the negative column
  ...
  rbind(s2_raw_Lepidoptera_limite0.03,sum0.03)->s2_raw_Lepidoptera_limite0.03
}

##**transform in present/absence table**
s2_raw_Lepidoptera_limite0.03->s2_raw_Lepidoptera_limite0.03
s2_raw_Lepidoptera_limite0.03[s2_raw_Lepidoptera_limite0.03>1]<-1 ##transform in present/absence table 

##**checking if there is any row with no presence**
s2_raw_Lepidoptera_limite0.03[,1:37]->data0.03
rowSums(data0.03)
...
##**Lepidoptera**
t(s2_raw_Lepidoptera_limite0.03)->t_s2_f4_Lepidoptera_limite0.03 ##trasp
t_s2_f4_Lepidoptera_limite0.03[1:37,]->community_Lepidoptera_limite0.03 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.03".
colnames(t_s2_f4_Lepidoptera_limite0.03)<-community_Lepidoptera_limite0.03[1,] 
as.data.frame(community_Lepidoptera_limite0.03)->community_Lepidoptera0.03 ##trasp including col and row names
...
dim(community_Lepidoptera0.03)
community_Lepidoptera0.03[which(str_extract (row.names(community_Lepidoptera0.03), "_NTO_") %in% "_NTO_"),]->community_Lepidoptera_Site0.03
dim(community_Lepidoptera_Site0.03)
community_Lepidoptera_Site0.03[,which(colSums(community_Lepidoptera_Site0.03)!=0)]->community_Lepidoptera_Site0.03 ##to remove no data colums
dim(community_Lepidoptera_Site0.03)
write.table (community_Lepidoptera_Site0.03, file="../genetic/Data_out/Lepidoptera/Lepidoptera3P/community_Lepidoptera_Site0.03.txt") ##this is necessary for the format, not able to solve in other way
...
##**Lepidoptera**
as.matrix(community_Lepidoptera_Site0.03)->community_Lepidoptera_Site0.03
row.names(community_Lepidoptera_Site0.03)->sample_names_Site0.03
dim(community_Lepidoptera_Site0.03)->dims_Site0.03
dims_Site0.03
.rowSums (community_Lepidoptera_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->sample_richness_Site0.03 ##summatory by rows
...
##Singletons by SITE
##summatory by rows
colnames(community_Lepidoptera_Site0.03)->h_names_Site0.03
dim (community_Lepidoptera_Site0.03)->dims_Site0.03
.colSums (community_Lepidoptera_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->h_ocurrence_Site0.03 ##summatory by cols
...
##**community_Lepidoptera_Site0.03**
##singletons
community_Lepidoptera_Site0.03[,singletons_Site0.03]->community_Lepidoptera_singletons_Site0.03
row.names(community_Lepidoptera_singletons_Site0.03)->sample_names_Site0.03
dim (community_Lepidoptera_singletons_Site0.03)->dims_Site0.03
dims_Site0.03
.rowSums (community_Lepidoptera_singletons_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->sample_richness_singletons_Site0.03 ##summatory by rows
...
##plot (MDSbetasim0.03, main="Lepidoptera_Site")
##with(general_sample_sinoutlayer0.03,ordispider(MDSbetasim0.03, ID, label=T, col="red"))
plot (MDSbetasim0.03, main="Lepidoptera_Site0.03")
x<- MDSbetasim0.03$points[,1]
y<- MDSbetasim0.03$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Lepidoptera_sinoutlayer0.03))

plot (MDSbetasim0.03, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Lepidoptera_Site_0.03")
with(general_sample_sinoutlayer0.03,ordispider(MDSbetasim0.03, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

plot (MDSbetasim0.03, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Lepidoptera_Site_0.03")

...
#####open table with names including Region and Sites parameters
...
s2_raw_Arachnida_limite0.03[,1:51]->data0.03 
rowSums(data0.03)
...
t_s2_f4_Arachnida_limite0.03[1:51,]->community_Arachnida_limite0.03 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.03".
...
dim(community_Arachnida0.03)
community_Arachnida0.03[which(str_extract (row.names(community_Arachnida0.03), "_NTO_") %in% "_NTO_"),]->community_Arachnida_Site0.03
...
##BY SITE
row.names(community_Arachnida_Site0.03)->sample_names_Mountain1_0.03
...
#**Arachnida**
as.matrix(community_Arachnida_Site0.03)->community_Arachnida_Site0.03
row.names(community_Arachnida_Site0.03)->sample_names_Site0.03
dim(community_Arachnida_Site0.03)->dims_Site0.03
dims_Site0.03
.rowSums (community_Arachnida_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->sample_richness_Site0.03 ##summatory by rows
rbind(sample_names_Site0.03,sample_richness_Site0.03)->richness_Site0.03_Arachnida
t(richness_Site0.03_Arachnida)->richness_Site0.03_Arachnida
colnames(richness_Site0.03_Arachnida)<-c("sample_names_Site0.03","sample_richness_Site0.03")
richness_Site0.03_Arachnida
as.data.frame(richness_Site0.03_Arachnida)->richness_Site0.03_Arachnida

##**Generating variables with SITE. En la tabla richnees. Generar variable de montana y sitio.** 
richness_Site0.03_Arachnida %>% separate(sample_names_Site0.03, c("Conservation","Mountain1","Site","ID"), sep="_",remove=FALSE)->richness_Site0.03_Arachnida
richness_Site0.03_Arachnida
richness_Site0.03_Arachnida %>% unite(Mountain1Site, Mountain1, Site, sep="_",remove=FALSE)->richness_Site0.03_Arachnida ##generating a variable combining layer and habitat
richness_Site0.03_Arachnida

##**Generating variables with in total SITE_C.**
richness_Site0.03_Arachnida %>% separate(sample_names_Site0.03, c("Conservation","Mountain1","Site","ID"), sep="_",remove=FALSE)->richness_SiteC
richness_SiteC
...
##**BY SITE**
write.table(richness_Site0.03_Arachnida, file="../genetic/Data_out/Arachnida/Arachnida3P/richness_Site_Arachnida_0.03.txt") ##this is the only way I found to be able to work later
...
##**BY SITE_C general**
write.table(richness_SiteC, file="../genetic/Data_out/Arachnida/Arachnida3P/richness_SiteC_Arachnida0.03.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Arachnida/Arachnida3P/richness_SiteC_Arachnida0.03.txt",header=TRUE)->richness_SiteC

##**General plot of richness by sample in SITE**
barplot(richness_Site0.03_Arachnida$sample_richness_Site0.03,col=richness_Site0.03_Arachnida$Mountain1Site,names.arg= richness_Site0.03_Arachnida$sample_names_Site0.03,las=2,cex.names=0.5, ylab="richness_Site0.03_Arachnida", main="H richness_Site Arachnida_0.03")
richness_Site0.03_Arachnida %>% group_by(Mountain1Site) %>% summarise(mean(sample_richness_Site0.03))

##**min, max, ds Summarise**
richness_Site0.03_Arachnida %>% group_by(Mountain1Site) %>% summarise(min(sample_richness_Site0.03))
richness_Site0.03_Arachnida %>% group_by(Mountain1Site) %>% summarise(max(sample_richness_Site0.03))
richness_Site0.03_Arachnida %>% group_by(Mountain1Site) %>% summarise(sd(sample_richness_Site0.03))
...
plot(richness_Site0.03_Arachnida$Mountain1Site,richness_Site0.03_Arachnida$sample_richness_Site0.03,ylab="richness_Site0.03_Arachnida", ylim=c(0,30), cex=1.4, cex.axis=2.3, lwd=2.5, main="Richness_Site Arachnida_0.03")
...
##Singletons by SITE
##summatory by rows
colnames(community_Arachnida_Site0.03)->h_names_Site0.03
dim (community_Arachnida_Site0.03)->dims_Site0.03
.colSums (community_Arachnida_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->h_ocurrence_Site0.03 ##summatory by cols
...
write.table(h_ocurrence_Site0.03, file="../genetic/Data_out/Arachnida/Arachnida3P/0.03_ocurrence_Site_Arachnida.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Arachnida/Arachnida3P/0.03_ocurrence_Site_Arachnida.txt",header=TRUE)->h_ocurrence_Site0.03
...
###community_Arachnida_Site0.03
###singletons
community_Arachnida_Site0.03[,singletons_Site0.03]->community_Arachnida_singletons_Site0.03
row.names(community_Arachnida_singletons_Site0.03)->sample_names_Site0.03
dim (community_Arachnida_singletons_Site0.03)->dims_Site0.03
dims_Site0.03
.rowSums (community_Arachnida_singletons_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->sample_richness_singletons_Site0.03 ##summatory by rows
...
text(x=38, y=5, labels="60.59%", cex=1.5)
#
...
plot (MDSbetasim0.03, main="Arachnida_Site_0.03") 
x<- MDSbetasim0.03$points[,1]
y<- MDSbetasim0.03$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Arachnida_Site0.03))

plot (MDSbetasim0.03, main="Arachnida_Site_0.03")
with(general_sample_Mountain1Site0.03,ordispider(MDSbetasim0.03, Site, label=T, col="blue"))

plot (MDSbetasim0.03, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Arachnida_Site_0.03")
...
plot (MDSbetasim0.03, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Arachnida_Site_0.03")

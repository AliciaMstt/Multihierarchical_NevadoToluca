...
read.table("../genetic/Data_out/Collembola/Collembola3P/h_ocurrence_Site_Collembola0.03.txt",header=TRUE)->h_ocurrence_Site

#' percentege of singletons by sample
h_ocurrence_Site
which(h_ocurrence_Site$h_ocurrence_Site==1)->singletons_Site0.03
length(singletons_Site0.03)
length(singletons_Site0.03)/length(h_ocurrence_Site$h_ocurrence_Site)*100
...
plot (MDSbetasim, main="Collembola_Site_0.03") 
...
plot (MDSbetasim, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Collembola_Site_0.03")
with(general_sample_Mountain1Site0.03,ordispider(MDSbetasim, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

#Anosim
anosim(beta.pair$beta.sim, general_sample_Mountain1Site0.03$Site, permutations=999)

plot (MDSbetasim, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5)
with(general_sample_Mountain1Site0.03,ordispider(MDSbetasim, Site, cex.lab=1, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0"), lwd=4.5))

...
write.table (community_Collembola_h, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola_h.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola_h.txt")->community_Collembola_h
#

####submatrixes of the Nevado Toluca del lado EAST de los haplotypes. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola_h)
community_Collembola_h[which(str_extract (row.names(community_Collembola_h), "_E_") %in% "_E_"),]->community_Collembola_h_East
dim(community_Collembola_h_East)
community_Collembola_h_East[,which(colSums(community_Collembola_h_East)!=0)]->community_Collembola_h_East ##to remove no data colums
dim(community_Collembola_h_East)
write.table (community_Collembola_h_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola_h_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola_h_East.txt")->community_Collembola_h_East
#
...
write.table (community_Collembola0.005, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.005.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.005.txt")->community_Collembola0.005


####Submatrixes of the Nevado Toluca del lado EAST de nivel 0.5%. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola0.005)
community_Collembola0.005[which(str_extract (row.names(community_Collembola0.005), "_E_") %in% "_E_"),]->community_Collembola0.005_East
dim(community_Collembola0.005_East)
community_Collembola0.005_East[,which(colSums(community_Collembola0.005_East)!=0)]->community_Collembola0.005_East ##to remove no data colums
dim(community_Collembola0.005_East)
write.table (community_Collembola0.005_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.005_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.005_East.txt")->community_Collembola0.005_East
#
...
write.table (community_Collembola0.015, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.015.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.015.txt")->community_Collembola0.015

####submatrixes of the Nevado Toluca del lado EAST de nivel 1.5%. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola0.015)
community_Collembola0.015[which(str_extract (row.names(community_Collembola0.015), "_E_") %in% "_E_"),]->community_Collembola0.015_East
dim(community_Collembola0.015_East)
community_Collembola0.015_East[,which(colSums(community_Collembola0.015_East)!=0)]->community_Collembola0.015_East ##to remove no data colums
dim(community_Collembola0.015_East)
write.table (community_Collembola0.015_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.015_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.015_East.txt")->community_Collembola0.015_East
#
...
write.table (community_Collembola0.02, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.02.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.02.txt")->community_Collembola0.02

####submatrixes of the Nevado Toluca del lado EAST de nivel 2.0%. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola0.02)
community_Collembola0.02[which(str_extract (row.names(community_Collembola0.02), "_E_") %in% "_E_"),]->community_Collembola0.02_East
dim(community_Collembola0.02_East)
community_Collembola0.02_East[,which(colSums(community_Collembola0.02_East)!=0)]->community_Collembola0.02_East ##to remove no data colums
dim(community_Collembola0.02_East)
write.table (community_Collembola0.02_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.02_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.02_East.txt")->community_Collembola0.02_East
#
...
write.table (community_Collembola0.03, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.03.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.03.txt")->community_Collembola0.03

####submatrixes of the Nevado Toluca del lado EAST de nivel 3.0%. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola0.03)
community_Collembola0.03[which(str_extract (row.names(community_Collembola0.03), "_E_") %in% "_E_"),]->community_Collembola0.03_East
dim(community_Collembola0.03_East)
community_Collembola0.03_East[,which(colSums(community_Collembola0.03_East)!=0)]->community_Collembola0.03_East ##to remove no data colums
dim(community_Collembola0.03_East)
write.table (community_Collembola0.03_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.03_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.03_East.txt")->community_Collembola0.03_East
#
...
write.table (community_Collembola0.05, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.05.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.05.txt")->community_Collembola0.05

####submatrixes of the Nevado Toluca del lado EAST de nivel 5.0%. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola0.05)
community_Collembola0.05[which(str_extract (row.names(community_Collembola0.05), "_E_") %in% "_E_"),]->community_Collembola0.05_East
dim(community_Collembola0.05_East)
community_Collembola0.05_East[,which(colSums(community_Collembola0.05_East)!=0)]->community_Collembola0.05_East ##to remove no data colums
dim(community_Collembola0.05_East)
write.table (community_Collembola0.05_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.05_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.05_East.txt")->community_Collembola0.05_East
#
...
write.table (community_Collembola0.075, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.075.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.075.txt")->community_Collembola0.075

####submatrixes of the Nevado Toluca del lado EAST de nivel 7.5%. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola0.075)
community_Collembola0.075[which(str_extract (row.names(community_Collembola0.075), "_E_") %in% "_E_"),]->community_Collembola0.075_East
dim(community_Collembola0.075_East)
community_Collembola0.075_East[,which(colSums(community_Collembola0.075_East)!=0)]->community_Collembola0.075_East ##to remove no data colums
dim(community_Collembola0.075_East)
write.table (community_Collembola0.075_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.075_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.075_East.txt")->community_Collembola0.075_East
#
...
write.table (community_Collembola0.029, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.029.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.029.txt")->community_Collembola0.029

####submatrixes of the Nevado Toluca del lado EAST de nivel GMYC. NOTA_Nancy: Quiero hacer tablas que incluyan datos con localidades del lado EAST dentro del Nevado de Toluca.
dim(community_Collembola0.029)
community_Collembola0.029[which(str_extract (row.names(community_Collembola0.029), "_E_") %in% "_E_"),]->community_Collembola0.029_East
dim(community_Collembola0.029_East)
community_Collembola0.029_East[,which(colSums(community_Collembola0.029_East)!=0)]->community_Collembola0.029_East ##to remove no data colums
dim(community_Collembola0.029_East)
write.table (community_Collembola0.029_East, file="../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.029_East.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_East/community_Collembola0.029_East.txt")->community_Collembola0.029_East
#
...
Resistance_matrix_East <- read.table("../spatial/IBDistanceMatrix/geomatrix_Site_EAST.txt", sep = ",", header=T, row.names = 1)
...
##**Plot all levels**
plot.decay(decay_h, ylim=c(0,1.0), xlim=c(1,5500), pch=20, lwd=4, cex.lab= 1.5, cex.axis= 1.5, col="#003695")
...
##**beta.pair_CollembolaEast_h**
beta.multi(community_Collembola_h_East, index.family="sorensen")->diss_mean_h
diss_mean_h$beta.SIM->diss_mean_h
beta.multi(community_Collembola0.005_East, index.family="sorensen")->diss_mean_0.005
diss_mean_0.005$beta.SIM->diss_mean_0.005
beta.multi(community_Collembola0.015_East, index.family="sorensen")->diss_mean_0.015
diss_mean_0.015$beta.SIM->diss_mean_0.015
beta.multi(community_Collembola0.02_East, index.family="sorensen")->diss_mean_0.02
diss_mean_0.02$beta.SIM->diss_mean_0.02
beta.multi(community_Collembola0.03_East, index.family="sorensen")->diss_mean_0.03
diss_mean_0.03$beta.SIM->diss_mean_0.03
beta.multi(community_Collembola0.05_East, index.family="sorensen")->diss_mean_0.05
diss_mean_0.05$beta.SIM->diss_mean_0.05
beta.multi(community_Collembola0.075_East, index.family="sorensen")->diss_mean_0.075
diss_mean_0.075$beta.SIM->diss_mean_0.075
beta.multi(community_Collembola0.029_East, index.family="sorensen")->diss_mean_0.029
...
dim(community_Collembola_h_East)[2]->n_h
dim(community_Collembola0.005_East)[2]->n_0.005
dim(community_Collembola0.015_East)[2]->n_0.015
dim(community_Collembola0.02_East)[2]->n_0.02
dim(community_Collembola0.03_East)[2]->n_0.03
dim(community_Collembola0.05_East)[2]->n_0.05
dim(community_Collembola0.075_East)[2]->n_0.075
dim(community_Collembola0.029_East)[2]->n_0.029

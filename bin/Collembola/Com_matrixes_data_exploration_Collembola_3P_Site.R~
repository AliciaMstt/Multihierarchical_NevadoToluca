...
##Collembola by samples
specaccum(community_Collembola_Site0.03, method = "rarefaction", permutations=1000)->cum_Site0.03
plot(cum_Site0.03, cex=1.4, cex.lab=1.4, cex.axis=2.3, lwd=3, ylim=c(0,100), xvar = "individuals")
specpool(community_Collembola_Site0.03)->specpool_Site0.03
specpool_Site0.03$Species/specpool_Site0.03$chao*100
text(x=600, y=5, labels="85.00%", cex=1.5)

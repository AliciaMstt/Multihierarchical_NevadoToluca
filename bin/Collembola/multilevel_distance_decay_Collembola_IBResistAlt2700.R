...
write.table (community_Collembola_h, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola_h.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola_h.txt")->community_Collembola_h
...
write.table (community_Collembola0.005, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.005.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.005.txt")->community_Collembola0.005
...
write.table (community_Collembola0.015, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.015.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.015.txt")->community_Collembola0.015
...
write.table (community_Collembola0.02, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.02.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.02.txt")->community_Collembola0.02
...
write.table (community_Collembola0.03, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.03.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.03.txt")->community_Collembola0.03
...
write.table (community_Collembola0.05, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.05.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.05.txt")->community_Collembola0.05
...
write.table (community_Collembola0.075, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.075.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.075.txt")->community_Collembola0.075
...
write.table (community_Collembola0.029, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.029.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt2700/community_Collembola0.029.txt")->community_Collembola0.029
...
Resistance_matrix_Site <- read.table("../spatial/IBResitanceElevationMatrix/Result_2700_resistances.txt",sep = ",", header=T, row.names = 1)

...
Diptera <- read.FASTA("../../../../genetic/Data_in/Diptera/7Diptera1015_zotus_Nostops.fasta")  #leer fasta
...
read.table ("../../../../genetic/Data_in/Diptera/7Diptera1015_zotus_Nostops.fasta", header=FALSE)->Diptera.fasta

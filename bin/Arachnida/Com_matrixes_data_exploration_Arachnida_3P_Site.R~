...
#BY SITE
write.table(richness_Site0.03, file="../../genetic/Data_out/Arachnida/Arachnida3P/richness_Site_Arachnida_0.03.txt") #'this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Arachnida/Arachnida3P/richness_Site_Arachnida_0.03.txt",header=TRUE)->richness_Site0.03
...
barplot(richness_Site0.03$sample_richness_Site0.03,col=richness_Site0.03$Mountain1Site,names.arg= richness_Site0.03$sample_names_Site0.03,las=2,cex.names=0.5, ylab="richness_Site0.03", main="H richness_Site Arachnida_0.03")

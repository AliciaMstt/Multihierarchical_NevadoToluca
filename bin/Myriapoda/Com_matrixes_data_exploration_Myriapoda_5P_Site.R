...
#**Community diversity and composition at the 5% Clustering level of the Myriapoda order**
...
data.frame()->s2_raw_Myriapoda_limite0.05
...
for (i in 1:length(unique (s2_raw_threshold$limite0.05)))
{
  ...
  subcom_level_names0.05[,c(2:29)]->subcom_level  #delete names, level and also the negative column
  colSums(subcom_level)->sum0.05
  as.data.frame(sum0.05)->sum0.05
  t(sum0.05)->sum0.05
  row.names(sum0.05)<-subcom_level_names0.05[1,1] #keep the name of the first haplotype
  rbind(s2_raw_Myriapoda_limite0.05,sum0.05)->s2_raw_Myriapoda_limite0.05
}

##**transform in present/absence table**
s2_raw_Myriapoda_limite0.05->s2_raw_Myriapoda_limite0.05
s2_raw_Myriapoda_limite0.05[s2_raw_Myriapoda_limite0.05>1]<-1 ##transform in present/absence table 

##**checking if there is any row with no presence**
s2_raw_Myriapoda_limite0.05[,1:28]->data0.05
rowSums(data0.05)
...
##**Myriapoda**
t(s2_raw_Myriapoda_limite0.05)->t_s2_f4_Myriapoda_limite0.05 ##trasp
t_s2_f4_Myriapoda_limite0.05[1:28,]->community_Myriapoda_limite0.05 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.05".
colnames(t_s2_f4_Myriapoda_limite0.05)<-community_Myriapoda_limite0.05[1,] 
as.data.frame(community_Myriapoda_limite0.05)->community_Myriapoda0.05 ##trasp including col and row names
####community_Acari[-49,]->community_Myriapoda ##removing neg
dim(community_Myriapoda0.05)
community_Myriapoda0.05[order(row.names(community_Myriapoda0.05)),]->community_Myriapoda0.05 ##order samples
write.table (community_Myriapoda0.05, file="../genetic/Data_out/Myriapoda/Myriapoda5P/community_Myriapoda0.05.txt") ##this is necessary for the format, not able to solve in other way
...
dim(community_Myriapoda0.05)
community_Myriapoda0.05[which(str_extract (row.names(community_Myriapoda0.05), "_NTO_") %in% "_NTO_"),]->community_Myriapoda_Site0.05
dim(community_Myriapoda_Site0.05)
community_Myriapoda_Site0.05[,which(colSums(community_Myriapoda_Site0.05)!=0)]->community_Myriapoda_Site0.05 ##to remove no data colums
dim(community_Myriapoda_Site0.05)
write.table (community_Myriapoda_Site0.05, file="../genetic/Data_out/Myriapoda/Myriapoda5P/community_Myriapoda_Site0.05.txt") ##this is necessary for the format, not able to solve in other way
...
##**BY SITE**
row.names(community_Myriapoda_Site0.05)->sample_names_Mountain1_0.05
...
general_sample_Mountain1Site_0.05
write.table(general_sample_Mountain1Site_0.05, file="../genetic/Data_out/Myriapoda/Myriapoda5P/general_sample_Mountain1Site_0.05.txt") ##this is the only way I found to be able to work later
...
##**Myriapoda**
as.matrix(community_Myriapoda_Site0.05)->community_Myriapoda_Site0.05
row.names(community_Myriapoda_Site0.05)->sample_names_Site0.05
dim(community_Myriapoda_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Myriapoda_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_Site0.05 ##summatory by rows
...
##**BY SITE**
write.table(richness_Site0.05, file="../genetic/Data_out/Myriapoda/Myriapoda5P/richness_Site0.05_Myriapoda.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Myriapoda/Myriapoda5P/richness_Site0.05_Myriapoda.txt",header=TRUE)->richness_Site0.05

##**BY SITE_C general**
write.table(richness_SiteC, file="../genetic/Data_out/Myriapoda/Myriapoda5P/richness_SiteC_Myriapoda.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Myriapoda/Myriapoda5P/richness_SiteC_Myriapoda.txt",header=TRUE)->richness_SiteC

##**General plot of richness by sample in SITE**
barplot(richness_Site0.05$sample_richness_Site0.05,col=richness_Site0.05$Mountain1Site,names.arg= richness_Site0.05$sample_names_Site0.05,las=2,cex.names=0.5, ylab="richness_Site0.05", main="H richness_Site Myriapoda_0.05")
...
##Singletons by SITE
##summatory by rows
colnames(community_Myriapoda_Site0.05)->h_names_Site0.05
dim (community_Myriapoda_Site0.05)->dims_Site0.05
.colSums (community_Myriapoda_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->h_ocurrence_Site0.05 ##summatory by cols
...
write.table(h_ocurrence_Site0.05, file="../genetic/Data_out/Myriapoda/Myriapoda5P/h_ocurrence_Site0.05_Myriapoda.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Myriapoda/Myriapoda5P/h_ocurrence_Site0.05_Myriapoda.txt",header=TRUE)->h_ocurrence_Site0.05
...
##**community_Myriapoda_Site0.05**
##singletons
community_Myriapoda_Site0.05[,singletons_Site0.05]->community_Myriapoda_singletons_Site0.05
row.names(community_Myriapoda_singletons_Site0.05)->sample_names_Site0.05
dim (community_Myriapoda_singletons_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Myriapoda_singletons_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_singletons_Site0.05 ##summatory by rows
...
plot(cum_Site0.05, cex=1.4, cex.lab=1.4, cex.axis=2.3, lwd=3, ylim=c(0,20), xlim=c(0,40), main="h_Myriapoda_Site_0.05")
specpool(community_Myriapoda_Site0.05)->specpool_Site0.05
specpool_Site0.05$Species/specpool_Site0.05$chao*100
text(x=38, y=5, labels="76.16%", cex=1.5)
mtext(c("Myriapoda"), side = 4, col = "black", line = 1, cex = 2)
#
...
plot (MDSbetasim0.05, main="Myriapoda_Site_0.05") 
x<- MDSbetasim0.05$points[,1]
y<- MDSbetasim0.05$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Myriapoda_Site0.05))

plot (MDSbetasim0.05, main="Myriapoda_Site_0.05")
with(general_sample_Mountain1Site_0.05,ordispider(MDSbetasim0.05, Site, label=T, col="blue"))

plot (MDSbetasim0.05, xlim=c(-0.5, 0.5), ylim=c(-0.5, 0.5), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Myriapoda_Site_0.05")
with(general_sample_Mountain1Site_0.05,ordispider(MDSbetasim0.05, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

plot (MDSbetasim0.05, xlim=c(-0.5, 0.5), ylim=c(-0.5, 0.5), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Myriapoda_Site_0.05")
...
##**Anosim**
anosim(beta.pair$beta.sim, general_sample_Mountain1Site_0.05$Site, permutations=999)

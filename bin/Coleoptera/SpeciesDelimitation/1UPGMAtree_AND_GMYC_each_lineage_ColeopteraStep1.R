#**Defining lineages at different clustering levels for Coleoptera order: STEP 1** 
...
#We used the result of the threshold time: e.g. "0.007255866" in the next analisys.

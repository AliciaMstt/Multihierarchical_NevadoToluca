...
dim(community_Myriapoda_Site_h)
write.table (community_Myriapoda_Site_h, file="../genetic/Data_out/Myriapoda/Myriapoda_Haplotypes/community_Myriapoda_Site_h.txt") ##this is necessary for the format, not able to solve in other way
...
##**BY SITE_C general**
write.table(richness_SiteC, file="../genetic/Data_out/Myriapoda/Myriapoda_Haplotypes/richness_SiteC_Myriapoda.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Myriapoda/Myriapoda_Haplotypes/richness_SiteC_Myriapoda.txt",header=TRUE)->richness_SiteC
...
text(x=38, y=5, labels="26.58%", cex=1.5)
#

...
write.table (community_Diptera_h, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera_h.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera_h.txt")->community_Diptera_h
...
write.table (community_Diptera0.005, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.005.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.005.txt")->community_Diptera0.005


#'submatrixes by MOUNTAIN. NOTA_Nancy: Quiero hacer tablas que incluyan datos de las tres montañas en la estación de seca.
#dim(community_Diptera0.005)
#community_Diptera0.005[which(str_extract (row.names(community_Diptera0.005), "_M_") %in% "_M_"),]->community_Diptera_Mountain
#dim(community_Diptera_Mountain)
#community_Diptera_Mountain[,which(colSums(community_Diptera_Mountain)!=0)]->community_Diptera_Mountain #'to remove no data colums
#dim(community_Diptera_Mountain)
...
write.table (community_Diptera0.015, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.015.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.015.txt")->community_Diptera0.015
...
write.table (community_Diptera0.02, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.02.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.02.txt")->community_Diptera0.02
...
write.table (community_Diptera0.03, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.03.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.03.txt")->community_Diptera0.03
...
write.table (community_Diptera0.05, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.05.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.05.txt")->community_Diptera0.05
...
write.table (community_Diptera0.075, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.075.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.075.txt")->community_Diptera0.075
...
write.table (community_Diptera0.0088, file="../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.0088.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Diptera/Diptera_IBR_VegRcl_J/community_Diptera0.0088.txt")->community_Diptera0.0088
...
Resistance_matrix_Site <- read.table("../spatial/IBResistanceVegTypeMatrix/Result_J_resistances.txt",sep = ",", header=T, row.names = 1)

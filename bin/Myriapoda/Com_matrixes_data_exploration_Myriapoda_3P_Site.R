...
##'Singletons by SITE
#'summatory by rows
colnames(community_Myriapoda_Site0.03)->h_names_Site
dim (community_Myriapoda_Site0.03)->dims_Site0.03
.colSums (community_Myriapoda_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->h_ocurrence_Site #'summatory by cols
...
write.table(h_ocurrence_Site, file="../genetic/Data_out/Myriapoda/Myriapoda3P/h_ocurrence_Site_Myriapoda.txt") #'this is the only way I found to be able to work later
read.table("../genetic/Data_out/Myriapoda/Myriapoda3P/h_ocurrence_Site_Myriapoda.txt",header=TRUE)->h_ocurrence_Site
...
#singletons
community_Myriapoda_Site0.03[,singletons_Site]->community_Myriapoda_singletons_Site0.03
...
#plot (MDSbetasim, main="Myriapoda_Site_0.03") 
#x<- MDSbetasim$points[,1]
#y<- MDSbetasim$points[,2]
#text(x, y, pos = 1, cex=0.7, labels = row.names (community_Myriapoda_Site0.03))

#plot (MDSbetasim, main="Myriapoda_Site_0.03")
#with(general_sample_Mountain1Site0.03,ordispider(MDSbetasim, Site, label=T, col="blue"))
...
general_sample_Mountain1Site0.03[-which(general_sample_Mountain1Site0.03$sample_names %in% c("CON_NTO_ASB_79ACON1")),]->general_sample_sinoutlayer
...
#plot (MDSbetasim, main="Myriapoda_Site")
...
#with(general_sample_sinoutlayer,ordispider(MDSbetasim, ID, label=T, col="red"))
#plot (MDSbetasim, main="Myriapoda_Site0.03")
plot (MDSbetasim, main="Myriapoda_Site")
x<- MDSbetasim$points[,1]
y<- MDSbetasim$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Myriapoda_sinoutlayer0.03))

plot (MDSbetasim, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Myriapoda_Site_0.03")
with(general_sample_sinoutlayer,ordispider(MDSbetasim, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

plot (MDSbetasim, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Myriapoda_Site_0.03")

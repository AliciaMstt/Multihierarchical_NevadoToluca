...
#**Community diversity and composition of Arachnida at Clustering level 5% lineages**
...
s2_raw_Arachnida_limite0.05[,1:51]->data0.05 
rowSums(data0.05)
...
t_s2_f4_Arachnida_limite0.05[1:51,]->community_Arachnida_limite0.05 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.05".
...
dim(community_Arachnida0.05)
community_Arachnida0.05[which(str_extract (row.names(community_Arachnida0.05), "_NTO_") %in% "_NTO_"),]->community_Arachnida_Site0.05
dim(community_Arachnida_Site0.05)
community_Arachnida_Site0.05[,which(colSums(community_Arachnida_Site0.05)!=0)]->community_Arachnida_Site0.05 ##to remove no data colums
dim(community_Arachnida_Site0.05)
write.table (community_Arachnida_Site0.05, file="../genetic/Data_out/Arachnida/Arachnida5P/community_Arachnida_Site0.05.txt") ##this is necessary for the format, not able to solve in other way
...
row.names(community_Arachnida_Site0.05)->sample_names_Mountain1_0.05
...
##**Arachnida**
as.matrix(community_Arachnida_Site0.05)->community_Arachnida_Site0.05
row.names(community_Arachnida_Site0.05)->sample_names_Site0.05
dim(community_Arachnida_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Arachnida_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_Site0.05 ##summatory by rows
rbind(sample_names_Site0.05,sample_richness_Site0.05)->richness_Site0.05_Arachnida
t(richness_Site0.05_Arachnida)->richness_Site0.05_Arachnida
colnames(richness_Site0.05_Arachnida)<-c("sample_names_Site0.05","sample_richness_Site0.05")
richness_Site0.05_Arachnida
as.data.frame(richness_Site0.05_Arachnida)->richness_Site0.05_Arachnida

##**Generating variables with SITE. En la tabla rishnees. Generar variable de montana y sitio.** 
richness_Site0.05_Arachnida %>% separate(sample_names_Site0.05, c("Conservation","Mountain1","Site","ID"), sep="_",remove=FALSE)->richness_Site0.05_Arachnida
richness_Site0.05_Arachnida
richness_Site0.05_Arachnida %>% unite(Mountain1Site, Mountain1, Site, sep="_",remove=FALSE)->richness_Site0.05_Arachnida ##generating a variable combining layer and habitat
richness_Site0.05_Arachnida

##**Generating variables with in total SITE_C.**
richness_Site0.05_Arachnida %>% separate(sample_names_Site0.05, c("Conservation","Mountain1","Site","ID"), sep="_",remove=FALSE)->richness_SiteC
richness_SiteC
...
##**BY SITE**
write.table(richness_Site0.05_Arachnida, file="../genetic/Data_out/Arachnida/Arachnida5P/richness_Site_Arachnida0.05.txt") ##this is the only way I found to be able to work later
...
barplot(richness_Site0.05_Arachnida$sample_richness_Site0.05,col=richness_Site0.05_Arachnida$Mountain1Site,names.arg= richness_Site0.05_Arachnida$sample_names_Site0.05,las=2,cex.names=0.5, ylab="richness_Site0.05_Arachnida", main="Richness_Site Arachnida_0.05")
richness_Site0.05_Arachnida %>% group_by(Mountain1Site) %>% summarise(mean(sample_richness_Site0.05))

##**min, max, ds Summarise**
richness_Site0.05_Arachnida %>% group_by(Mountain1Site) %>% summarise(min(sample_richness_Site0.05))
richness_Site0.05_Arachnida %>% group_by(Mountain1Site) %>% summarise(max(sample_richness_Site0.05))
richness_Site0.05_Arachnida %>% group_by(Mountain1Site) %>% summarise(sd(sample_richness_Site0.05))
...
plot(richness_Site0.05_Arachnida$Mountain1Site,richness_Site0.05_Arachnida$sample_richness_Site0.05,ylab="richness_Site0.05_Arachnida", ylim=c(0,30), cex=1.4, cex.axis=2.3, lwd=2.5, main="Richness_Site Arachnida_0.05")
...
##Singletons by SITE
##summatory by rows
colnames(community_Arachnida_Site0.05)->h_names_Site0.05
dim (community_Arachnida_Site0.05)->dims_Site0.05
.colSums (community_Arachnida_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->h_ocurrence_Site0.05 ##summatory by cols
...
##community_Arachnida_Site0.05
##singletons
community_Arachnida_Site0.05[,singletons_Site0.05]->community_Arachnida_singletons_Site0.05
row.names(community_Arachnida_singletons_Site0.05)->sample_names_Site0.05
dim (community_Arachnida_singletons_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Arachnida_singletons_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_singletons_Site0.05 ##summatory by rows
...
plot(cum_Site0.05, cex=1.4, cex.lab=1.4, cex.axis=2.3, lwd=3, ylim=c(0,100), main="h_Arachnida_Site_0.05")
...
plot (MDSbetasim0.05, main="Arachnida_Site_0.05") 
x<- MDSbetasim0.05$points[,1]
y<- MDSbetasim0.05$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Arachnida_Site0.05))

plot (MDSbetasim0.05, main="Arachnida_Site_0.05")
with(general_sample_Mountain1Site0.05,ordispider(MDSbetasim0.05, Site, label=T, col="blue"))

plot (MDSbetasim0.05, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Arachnida_Site_0.05")
with(general_sample_Mountain1Site0.05,ordispider(MDSbetasim0.05, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

##**Anosim**
anosim(beta.pair$beta.sim, general_sample_Mountain1Site0.05$Site, permutations=999)

plot (MDSbetasim0.05, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Arachnida_Site_0.05")

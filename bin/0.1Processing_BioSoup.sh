...
#3.PRIMER TRIMMING (fragment length 420)
cd ../genetic/raw
mkdir -p PTRIM420
for file in *R1.fastq
do
	fastx_trimmer -f 20 -i ${file} -o ./PTRIM420/${file%.*}.Ptrim.fq
done

for file2 in *R2.fastq
do
	fastx_trimmer -f 26 -i ${file2} -o ./PTRIM420/${file2%.*}.Ptrim.fq 
done
...
#sortbylength and keeping only reads of 420
...
do	
	...
	../../../../../../../.././bin/usearch10.0.240_i86linux32 -sortbylength $f1 -fastaout ./LENGTH420/$f2 -minseqlength 420 -maxseqlength 420 &> ./LENGTH420/$f2log

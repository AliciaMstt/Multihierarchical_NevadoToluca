...
dim(community_Coleoptera_Site0.05)
write.table (community_Coleoptera_Site0.05, file="../genetic/Data_out/Coleoptera/Coleoptera5P/community_Coleoptera_Site0.05.txt") ##this is necessary for the format, not able to solve in other way
...
##**BY SITE_C general**
write.table(richness_SiteC, file="../genetic/Data_out/Coleoptera/Coleoptera5P/richness_SiteC_Coleoptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Coleoptera/Coleoptera5P/richness_SiteC_Coleoptera.txt",header=TRUE)->richness_SiteC

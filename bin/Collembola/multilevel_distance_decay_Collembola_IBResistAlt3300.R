...
write.table (community_Collembola_h, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola_h.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola_h.txt")->community_Collembola_h
...
write.table (community_Collembola0.005, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.005.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.005.txt")->community_Collembola0.005
...
write.table (community_Collembola0.015, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.015.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.015.txt")->community_Collembola0.015
...
write.table (community_Collembola0.02, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.02.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.02.txt")->community_Collembola0.02

#'submatrixes by MOUNTAIN. NOTA_Nancy: Quiero hacer tablas que incluyan datos de las tres montañas en la estación de seca.
#dim(community_Collembola0.02)
#community_Collembola0.02[which(str_extract (row.names(community_Collembola0.02), "_M_") %in% "_M_"),]->community_Collembola_Mountain
#dim(community_Collembola_Mountain)
#community_Collembola_Mountain[,which(colSums(community_Collembola_Mountain)!=0)]->community_Collembola_Mountain #'to remove no data colums
#dim(community_Collembola_Mountain)
...
write.table (community_Collembola0.03, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.03.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.03.txt")->community_Collembola0.03
...
write.table (community_Collembola0.05, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.05.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.05.txt")->community_Collembola0.05
...
write.table (community_Collembola0.075, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.075.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.075.txt")->community_Collembola0.075
...
write.table (community_Collembola0.029, file="../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.029.txt") #'this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBR_Alt3300/community_Collembola0.029.txt")->community_Collembola0.029
...
Resistance_matrix_Site <- read.table("../spatial/IBResitanceElevationMatrix/Result_3300_resistances.txt",sep = ",", header=T, row.names = 1)
...
#Plot all levels
plot.decay(decay_h, ylim=c(0,1.0), xlim=c(0,6), pch=20, lwd=4, cex.lab= 1.5, cex.axis= 1.5, col="#000075")
...
Miscolores<-c("#000075", "#cfebf3", "#66b2b2", "#2b72a6","#1d5686","#0a3056")

#Plot with levels: Haplotype, 0.5, 1.5, 3, 5, 7.5
plot.decay(decay_h, col=Miscolores, legend.text = c("H","NC0.5","NC1.5","NC3","NC5","NC7.5","NC")ylim=c(0,1.0), xlim=c(0,6), pch=20, lwd=4, cex.lab= 1.5, cex.axis= 1.5, col="#000075")
plot.decay(decay_0.005,add=T,pch=20,lwd=4,col="#cfebf3")
plot.decay(decay_0.015,add=T,pch=20,lwd=4,col="#66b2b2")
#plot.decay(decay_0.02,add=T,pch=20,lwd=4,col="#27a397")
plot.decay(decay_0.03,add=T,pch=20,lwd=4,col="#2b72a6")
...
Miscolores<-c("plum", "hotpink", "gold", "chocolate", "darkturquoise", "orange", "skyblue", "gray90", "mediumorchid", "gray")

barplot(sort(MisZotus$Zotus, decreasing=TRUE), col=Miscolores,
               legend.text = c("Diptera","Collembola","Arachnida","Paraneoptera","Hymenoptera", "Coleoptera","Myriapoda","Others","Lepidoptera", "Annelida"), ylim=c(0,2500), ylab ="Frecuencias Relativas", xlab = "Orders", border = T, las=2, lwd=1.8)

#**Defining Lepidoptera lineage at different clustering levels: STEP 1** 
...
Lepidoptera_UPGMA <- upgma(dist_Lepidoptera)  #hacer árbol
...
Lepidoptera_UPGMA.GMYC.singleThreshold<-gmyc.edit(Lepidoptera_UPGMA, method="s") #hacer GMYC
#resumen de los resultados
summary(Lepidoptera_UPGMA.GMYC.singleThreshold) #Mostrar resumen GMYC

sink("Lepidoptera/SpeciesDelimitation/Lepidoptera_UPGMA.GMYC.singleThreshold.log", type=c("output","message"), split=TRUE) #guardar resultado del GMYC (resumen)
#MIT.test.s o MIT.test.m para ver todos los datos
summary(Lepidoptera_UPGMA.GMYC.singleThreshold)
sink()

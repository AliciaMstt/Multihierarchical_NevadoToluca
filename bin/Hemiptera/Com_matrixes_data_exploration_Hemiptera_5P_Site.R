...
dim(community_Hemiptera_Site0.05)
write.table (community_Hemiptera_Site0.05, file="../genetic/Data_out/Hemiptera/Hemiptera5P/community_Hemiptera_Site0.05.txt") ##this is necessary for the format, not able to solve in other way
...
text(x=38, y=5, labels="60.77%", cex=1.5)
mtext(c("Hemiptera"), side = 4, col = "black", line = 1, cex = 2)
#

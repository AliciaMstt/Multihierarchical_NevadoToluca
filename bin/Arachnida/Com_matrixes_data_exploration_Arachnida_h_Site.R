...
#BY SITE_C general
write.table(richness_SiteC, file="../genetic/Data_out/Arachnida/Arachnida_Haplotypes/richness_SiteC_Diptera.txt") #'this is the only way I found to be able to work later
read.table("../genetic/Data_out/Arachnida/Arachnida_Haplotypes/richness_SiteC_Diptera.txt",header=TRUE)->richness_SiteC

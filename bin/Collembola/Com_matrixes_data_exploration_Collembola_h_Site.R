...
#'**Community diversity and composition at the haplotype level of the Collembola order**'#
...
dim(community_Collembola_h)
community_Collembola_h[which(str_extract (row.names(community_Collembola_h), "_NTO_") %in% "_NTO_"),]->community_Collembola_Site_h
...
row.names(community_Collembola_Site_h)->sample_names_Mountain1_h
...
#'*Collembola*
as.matrix(community_Collembola_Site_h)->community_Collembola_Site_h
row.names(community_Collembola_Site_h)->sample_names_Site_h
dim(community_Collembola_Site_h)->dims_Site_h
dims_Site_h
.rowSums (community_Collembola_Site_h,dims_Site_h[1],dims_Site_h[2])->sample_richness_Site_h #'summatory by rows
rbind(sample_names_Site_h,sample_richness_Site_h)->richness_Site_h_Collembola
t(richness_Site_h_Collembola)->richness_Site_h_Collembola
colnames(richness_Site_h_Collembola)<-c("sample_names_Site_h","sample_richness_Site_h")
richness_Site_h_Collembola
as.data.frame(richness_Site_h_Collembola)->richness_Site_h_Collembola

##'Generating variables with SITE. En la tabla rishnees. Generar variable de montana y sitio. 
richness_Site_h_Collembola %>% separate(sample_names_Site_h, c("Conservation","Mountain1","Site","ID"), sep="_",remove=FALSE)->richness_Site_h_Collembola
richness_Site_h_Collembola
richness_Site_h_Collembola %>% unite(Mountain1Site, Mountain1, Site, sep="_",remove=FALSE)->richness_Site_h_Collembola #'generating a variable combining layer and habitat
richness_Site_h_Collembola

##'Generating variables with in total SITE_C.
richness_Site_h_Collembola %>% separate(sample_names_Site_h, c("Conservation","Mountain1","Site","ID"), sep="_",remove=FALSE)->richness_SiteC
richness_SiteC
...
#BY SITE
write.table(richness_Site_h_Collembola, file="../genetic/Data_out/Collembola/Collembola_Haplotypes/richness_Site_h_Collembola.txt") #'this is the only way I found to be able to work later
...
barplot(richness_Site_h_Collembola$sample_richness_Site_h,col=richness_Site_h_Collembola$Mountain1Site,names.arg= richness_Site_h_Collembola$sample_names_Site_h, las=2,cex.names=0.5, ylab="richness_Site_h_Collembola", main="H richness_Site Collembola")
richness_Site_h_Collembola %>% group_by(Mountain1Site) %>% summarise(mean(sample_richness_Site_h))

#min, max, ds Summarise
richness_Site_h_Collembola %>% group_by(Mountain1Site) %>% summarise(min(sample_richness_Site_h))
richness_Site_h_Collembola %>% group_by(Mountain1Site) %>% summarise(max(sample_richness_Site_h))
richness_Site_h_Collembola %>% group_by(Mountain1Site) %>% summarise(sd(sample_richness_Site_h))
...
plot(richness_Site_h_Collembola$Mountain1Site,richness_Site_h_Collembola$sample_richness_Site_h,ylab="richness_Site_h_Collembola", cex=1.4, cex.axis=2.3, lwd=2.5, ylim=c(0,60))
...
##'Singletons by SITE
#'summatory by rows
colnames(community_Collembola_Site_h)->h_names_Collembola_Site
dim (community_Collembola_Site_h)->dims_Site_h
.colSums (community_Collembola_Site_h,dims_Site_h[1],dims_Site_h[2])->h_ocurrence_Collembola_Site #'summatory by cols

rbind(h_names_Collembola_Site,h_ocurrence_Collembola_Site)->h_ocurrence_Collembola_Site
...
which(h_ocurrence_Collembola_Site$h_ocurrence_Collembola_Site==1)->singletons_Site_h
length(singletons_Site_h)
length(singletons_Site_h)/length(h_ocurrence_Collembola_Site$h_ocurrence_Collembola_Site)*100

#' percentege of h in more than 2 samples
which(h_ocurrence_Collembola_Site$h_ocurrence_Collembola_Site>2)->more2_Site_h
more2_Site_h
length(more2_Site_h)
length(more2_Site_h)/length(h_ocurrence_Collembola_Site$h_ocurrence_Collembola_Site)*100

#'number of singletons by SITE
#community_Collembola_Site_h
#singletons
community_Collembola_Site_h[,singletons_Site_h]->community_Collembola_singletons_Site_h
row.names(community_Collembola_singletons_Site_h)->sample_names_Site_h
dim (community_Collembola_singletons_Site_h)->dims_Site_h
dims_Site_h
.rowSums (community_Collembola_singletons_Site_h,dims_Site_h[1],dims_Site_h[2])->sample_richness_singletons_Site_h #'summatory by rows
...
plot (MDSbetasim_h, main="Collembola_Site_h") 
x<- MDSbetasim_h$points[,1]
y<- MDSbetasim_h$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Collembola_Site_h))

plot (MDSbetasim_h, main="Collembola_Site_h")
with(general_sample_Mountain1Site_h,ordispider(MDSbetasim_h, Site, label=T, col="blue"))

plot (MDSbetasim_h, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Collembola_Site_h")

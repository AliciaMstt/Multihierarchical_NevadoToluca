...
s2_raw_Diptera_limite0.05[,1:51]->data0.05 
rowSums(data0.05)
...
t_s2_f4_Diptera_limite0.05[1:51,]->community_Diptera_limite0.05 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.05".
...
dim(community_Diptera0.05)
community_Diptera0.05[which(str_extract (row.names(community_Diptera0.05), "_NTO_") %in% "_NTO_"),]->community_Diptera_Site0.05
dim(community_Diptera_Site0.05)
community_Diptera_Site0.05[,which(colSums(community_Diptera_Site0.05)!=0)]->community_Diptera_Site0.05 ##to remove no data colums
dim(community_Diptera_Site0.05)
write.table (community_Diptera_Site0.05, file="../genetic/Data_out/Diptera/Diptera5P/community_Diptera_Site0.05.txt") ##this is necessary for the format, not able to solve in other way
...
##BY SITE
##**Generating a general table with names and habitat parameters**
row.names(community_Diptera_Site0.05)->sample_names_Mountain1_0.05
...
general_sample_Mountain1Site0.05
write.table(general_sample_Mountain1Site0.05, file="../genetic/Data_out/Diptera/Diptera5P/general_sample_Mountain1Site0.05.txt") ##this is the only way I found to be able to work later
...
#**Diptera**
as.matrix(community_Diptera_Site0.05)->community_Diptera_Site0.05
row.names(community_Diptera_Site0.05)->sample_names_Site0.05
dim(community_Diptera_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Diptera_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_Site0.05 ##summatory by rows
...
##**BY SITE**
write.table(richness_Site0.05, file="../genetic/Data_out/Diptera/Diptera5P/richness_Site0.05_Diptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Diptera/Diptera5P/richness_Site0.05_Diptera.txt",header=TRUE)->richness_Site0.05

##**BY SITE_C general**
write.table(richness_SiteC, file="../genetic/Data_out/Diptera/Diptera5P/richness_SiteC_Diptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Diptera/Diptera5P/richness_SiteC_Diptera.txt",header=TRUE)->richness_SiteC

##**General plot of richness by sample in SITE**
barplot(richness_Site0.05$sample_richness_Site0.05,col=richness_Site0.05$Mountain1Site,names.arg= richness_Site0.05$sample_names_Site0.05,las=2,cex.names=0.5, ylab="richness_Site0.05", main="H richness_Site Diptera_0.05")
...
##Singletons by SITE
##summatory by rows
colnames(community_Diptera_Site0.05)->h_names_Site0.05
dim (community_Diptera_Site0.05)->dims_Site0.05
.colSums (community_Diptera_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->h_ocurrence_Site0.05 ##summatory by cols
...
write.table(h_ocurrence_Site0.05, file="../genetic/Data_out/Diptera/Diptera5P/h_ocurrence_Site0.05_Diptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Diptera/Diptera5P/h_ocurrence_Site0.05_Diptera.txt",header=TRUE)->h_ocurrence_Site0.05
...
##community_Diptera_Site0.05
##singletons
community_Diptera_Site0.05[,singletons_Site0.05]->community_Diptera_singletons_Site0.05
row.names(community_Diptera_singletons_Site0.05)->sample_names_Site0.05
dim (community_Diptera_singletons_Site0.05)->dims_Site0.05
dims_Site0.05
.rowSums (community_Diptera_singletons_Site0.05,dims_Site0.05[1],dims_Site0.05[2])->sample_richness_singletons_Site0.05 ##summatory by rows
...
plot (MDSbetasim0.05, main="Diptera_Site_0.05") 
x<- MDSbetasim0.05$points[,1]
y<- MDSbetasim0.05$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Diptera_Site0.05))

plot (MDSbetasim0.05, main="Diptera_Site_0.05")
with(general_sample_Mountain1Site0.05,ordispider(MDSbetasim0.05, Site, label=T, col="blue"))

plot (MDSbetasim0.05, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Diptera_Site_0.05")

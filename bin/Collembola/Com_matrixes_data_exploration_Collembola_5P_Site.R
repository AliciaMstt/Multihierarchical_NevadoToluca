...
general_sample_Mountain1Site_0.05
write.table(general_sample_Mountain1Site_0.05, file="../genetic/Data_out/Collembola/Collembola5P/general_sample_Mountain1Site_0.05.txt") #'this is the only way I found to be able to work later
read.table("../genetic/Data_out/Collembola/Collembola5P/general_sample_Mountain1Site_0.05.txt",header=TRUE)->general_sample_Mountain1Site_0.05
...
row.names(community_Collembola_Site0.05)->sample_names_Site_0.05
...
rbind(sample_names_Site_0.05,sample_richness_Site0.05)->richness_Site0.05
t(richness_Site0.05)->richness_Site0.05
colnames(richness_Site0.05)<-c("sample_names_Site_0.05","sample_richness_Site0.05")
richness_Site0.05
...
richness_Site0.05 %>% separate(sample_names_Site_0.05, c("Conservation","Mountain1","Site","ID"), sep="_",remove=FALSE)->richness_Site0.05
richness_Site0.05
...
#BY SITE
write.table(richness_Site0.05, file="../genetic/Data_out/Collembola/Collembola5P/richness_Site_Collembola0.05.txt") #'this is the only way I found to be able to work later
read.table("../genetic/Data_out/Collembola/Collembola5P/richness_Site_Collembola0.05.txt",header=TRUE)->richness_Site0.05

##'General plot of richness by sample in SITE
barplot(richness_Site0.05$sample_richness_Site0.05,col=richness_Site0.05$Mountain1Site,names.arg= richness_Site0.05$sample_names_Site_0.05,las=2,cex.names=0.5, ylab="richness_Site0.05", main="H richness_Site_Collembola_0.05")
...
row.names(community_Collembola_singletons_Site0.05)->sample_names_Site_0.05
...
rbind(sample_names_Site_0.05,sample_richness_singletons_Site0.05)->richness_singletons_Site0.05
t(richness_singletons_Site0.05)->richness_singletons_Site0.05
colnames(richness_singletons_Site0.05)<-c("sample_names_Site_0.05","sample_richness_singletons_Site0.05")

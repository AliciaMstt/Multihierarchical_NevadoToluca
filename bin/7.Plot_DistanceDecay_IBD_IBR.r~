...
png(filename="../figures/Figure5_DistanceDecay_Flat_Altitude.png", width=750 , height=920, units="px") # set size of the file to plot 
...
mtext(c("Collembola"), side = 4, adj = 0, col = "black", line = 2, cex=2)
...
mtext(c("Diptera"), side = 4, adj = 0, col = "black", line = 2, cex=2)
...
png(filename="../figures/Figure6_DistanceDecay_FinerScaleFlat.png", width=750 , height=920, units="px") # set size of the file to plot 
par(mfrow=c(2,2), mar = c(1.5, 1.5, 1.5, 1.5), omi=c(0.5, 0.5, 0.5, 2)) #the number of rows and columns the figure would have
...
png(filename="../figures/FigureS6_DistanceDecay_FinerScaleAltitudes.png", width=750 , height=920, units="px") # set size of the file to plot 
par(mfrow=c(2,2), mar = c(1.5, 1.5, 1.5, 1.5), omi=c(0.5, 0.5, 0.5, 2)) #the number of rows and columns the figure would have

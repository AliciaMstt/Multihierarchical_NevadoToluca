...
dim(community_Coleoptera_Site0.03)
write.table (community_Coleoptera_Site0.03, file="../genetic/Data_out/Coleoptera/Coleoptera3P/community_Coleoptera_Site0.03.txt") ##this is necessary for the format, not able to solve in other way
...
dims_Site0.03
.rowSums (community_Coleoptera_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->sample_richness_Site0.03 ##summatory by rows
...
##**BY SITE**
write.table(richness_Site0.03, file="../genetic/Data_out/Coleoptera/Coleoptera3P/richness_Site_Coleoptera0.03.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Coleoptera/Coleoptera3P/richness_Site_Coleoptera0.03.txt",header=TRUE)->richness_Site0.03

##**BY SITE_C general**
write.table(richness_SiteC, file="../genetic/Data_out/Coleoptera/Coleoptera3P/richness_SiteC_Coleoptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Coleoptera/Coleoptera3P/richness_SiteC_Coleoptera.txt",header=TRUE)->richness_SiteC

##**General plot of richness by sample in SITE**
barplot(richness_Site0.03$sample_richness_Site0.03,col=richness_Site0.03$Mountain1Site,names.arg= richness_Site0.03$sample_names_Site0.03,las=2,cex.names=0.5, ylab="richness_Site0.03", main="H richness_Site Coleoptera_0.03")
...
##Singletons by SITE
##summatory by rows
colnames(community_Coleoptera_Site0.03)->h_names_Site0.03
dim (community_Coleoptera_Site0.03)->dims_Site0.03
.colSums (community_Coleoptera_Site0.03,dims_Site0.03[1],dims_Site0.03[2])->h_ocurrence_Site0.03 ##summatory by cols
...
write.table(h_ocurrence_Site0.03, file="../genetic/Data_out/Coleoptera/Coleoptera3P/h_ocurrence_Site0.03_Coleoptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Coleoptera/Coleoptera3P/h_ocurrence_Site0.03_Coleoptera.txt",header=TRUE)->h_ocurrence_Site0.03
...
##singletons
community_Coleoptera_Site0.03[,singletons_Site0.03]->community_Coleoptera_singletons_Site0.03
...
text(x=38, y=5, labels="49.22%", cex=1.5)
#

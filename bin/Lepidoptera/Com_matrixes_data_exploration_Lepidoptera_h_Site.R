...
#**Community diversity and composition at the haplotype level of the Lepidoptera order**#
...
s2_raw_threshold [,1:38]->s2_raw_threshold ##remove threshold col
dim(s2_raw_threshold)
colnames(s2_raw_threshold)

##**transform in present/absence table**
s2_raw_threshold->s2_f4_h #NOTA_Nancy: Tengo un subset de Lepidoptera
...
t_s2_f4_h[2:38,]->community_Lepidoptera_h #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data".
colnames(community_Lepidoptera_h)<-t_s2_f4_h[1,]
as.data.frame(community_Lepidoptera_h)->community_Lepidoptera_h ##trasp including col and row names
####community_Acari[-49,]->community_Lepidoptera ##removing neg
dim(community_Lepidoptera_h)
community_Lepidoptera_h[order(row.names(community_Lepidoptera_h)),]->community_Lepidoptera_h ##order samples
write.table (community_Lepidoptera_h, file="../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/community_Lepidoptera_h.txt") ##this is necessary for the format, not able to solve in other way
...
dim(community_Lepidoptera_h)
community_Lepidoptera_h[which(str_extract (row.names(community_Lepidoptera_h), "_NTO_") %in% "_NTO_"),]->community_Lepidoptera_Site_h
dim(community_Lepidoptera_Site_h)
community_Lepidoptera_Site_h[,which(colSums(community_Lepidoptera_Site_h)!=0)]->community_Lepidoptera_Site_h ##to remove no data colums
dim(community_Lepidoptera_Site_h)
write.table (community_Lepidoptera_Site_h, file="../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/community_Lepidoptera_Site_h.txt") ##this is necessary for the format, not able to solve in other way
...
##**BY SITE**
row.names(community_Lepidoptera_Site_h)->sample_names_Mountain1_h
...
general_sample_Mountain1Site_h
write.table(general_sample_Mountain1Site_h, file="../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/general_sample_Mountain1Site_h.txt") ##this is the only way I found to be able to work later
...
##**Lepidoptera**
as.matrix(community_Lepidoptera_Site_h)->community_Lepidoptera_Site_h
row.names(community_Lepidoptera_Site_h)->sample_names_Site_h
dim(community_Lepidoptera_Site_h)->dims_Site_h
dims_Site_h
.rowSums (community_Lepidoptera_Site_h,dims_Site_h[1],dims_Site_h[2])->sample_richness_Site_h ##summatory by rows
...
##**BY SITE**
write.table(richness_Site_h, file="../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/richness_Site_h_Lepidoptera.txt") ##this is the only way I found to be able to work later
...
##**BY SITE_C general**
write.table(richness_SiteC, file="../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/richness_SiteC_Lepidoptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/richness_SiteC_Lepidoptera.txt",header=TRUE)->richness_SiteC

##**General plot of richness by sample in SITE**
barplot(richness_Site_h$sample_richness_Site_h,col=richness_Site_h$Mountain1Site,names.arg= richness_Site_h$sample_names_Site_h, las=2,cex.names=0.5, ylab="richness_Site_h", main="H richness_Site Lepidoptera")
...
##Singletons by SITE
##summatory by rows
colnames(community_Lepidoptera_Site_h)->h_names_Site
dim (community_Lepidoptera_Site_h)->dims_Site_h
.colSums (community_Lepidoptera_Site_h,dims_Site_h[1],dims_Site_h[2])->h_ocurrence_Site ##summatory by cols
...
write.table(h_ocurrence_Site, file="../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/h_ocurrence_Site_Lepidoptera.txt") ##this is the only way I found to be able to work later
read.table("../genetic/Data_out/Lepidoptera/Lepidoptera_Haplotypes/h_ocurrence_Site_Lepidoptera.txt",header=TRUE)->h_ocurrence_Site

##**percentege of singletons by sample**
h_ocurrence_Site
which(h_ocurrence_Site$h_ocurrence_Site==1)->richness_Site_h
length(richness_Site_h)
length(richness_Site_h)/length(h_ocurrence_Site$h_ocurrence_Site)*100
...
##**community_Lepidoptera_Site_h**
##singletons
community_Lepidoptera_Site_h[,richness_Site_h]->community_Lepidoptera_singletons_Site_h
row.names(community_Lepidoptera_singletons_Site_h)->sample_names_Site_h
dim (community_Lepidoptera_singletons_Site_h)->dims_Site_h
dims_Site_h
.rowSums (community_Lepidoptera_singletons_Site_h,dims_Site_h[1],dims_Site_h[2])->sample_richness_singletons_Site_h ##summatory by rows
...
plot(cum_Site_h, cex=1.4, cex.lab=1.4, cex.axis=2.3, lwd=3, xlim=c(0,40), main="h_Lepidoptera_Site")
specpool(community_Lepidoptera_Site_h)->specpool_Site_h
specpool_Site_h$Species/specpool_Site_h$chao*100
text(x=38, y=5, labels="57.14%", cex=1.5)
#
...
##plot (MDSbetasim_h, main="Lepidoptera_Site_h") 
##x<- MDSbetasim_h$points[,1]
##y<- MDSbetasim_h$points[,2]
##text(x, y, pos = 1, cex=0.7, labels = row.names (community_Lepidoptera_Site_h))
...
##plot (MDSbetasim_h, main="Lepidoptera_Site")
...
plot (MDSbetasim_h, main="Lepidoptera_Siteh")
x<- MDSbetasim_h$points[,1]
y<- MDSbetasim_h$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Lepidoptera_sinoutlayer_h))

plot (MDSbetasim_h, xlim=c(-0.5, 0.5), ylim=c(-0.49, 0.49), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Lepidoptera_Site_h")
with(general_sample_sinoutlayer_h,ordispider(MDSbetasim_h, Site, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0")))

plot (MDSbetasim_h, xlim=c(-0.5, 0.5), ylim=c(-0.49, 0.49), cex=2, cex.lab=1, cex.axis=2.3, lwd=4.5, main="Lepidoptera_Site_h")

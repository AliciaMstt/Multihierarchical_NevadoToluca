...
s2_raw_all <- read.table("../genetic/Data_in/Collembola/s2_raw_all_Collembola_threshold.txt", header=TRUE, sep = ",")
dim(s2_raw_all)
...
write.table (community_Collembola_h, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola_h.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola_h.txt")->community_Collembola_h
...
dim(community_Collembola_h_Site)
write.table (community_Collembola_h_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola_h_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola_h_Site.txt")->community_Collembola_h_Site
#
...
write.table (community_Collembola0.005, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.005.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.005.txt")->community_Collembola0.005
...
dim(community_Collembola0.005_Site)
write.table (community_Collembola0.005_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.005_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.005_Site.txt")->community_Collembola0.005_Site
#
...
write.table (community_Collembola0.015, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.015.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.015.txt")->community_Collembola0.015
...
dim(community_Collembola0.015_Site)
write.table (community_Collembola0.015_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.015_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.015_Site.txt")->community_Collembola0.015_Site
#
...
write.table (community_Collembola0.02, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.02.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.02.txt")->community_Collembola0.02
...
dim(community_Collembola0.02_Site)
write.table (community_Collembola0.02_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.02_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.02_Site.txt")->community_Collembola0.02_Site
#
...
write.table (community_Collembola0.03, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.03.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.03.txt")->community_Collembola0.03
...
dim(community_Collembola0.03_Site)
write.table (community_Collembola0.03_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.03_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.03_Site.txt")->community_Collembola0.03_Site
#
...
write.table (community_Collembola0.05, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.05.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.05.txt")->community_Collembola0.05
...
dim(community_Collembola0.05_Site)
write.table (community_Collembola0.05_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.05_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.05_Site.txt")->community_Collembola0.05_Site
#
...
write.table (community_Collembola0.075, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.075.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.075.txt")->community_Collembola0.075
...
dim(community_Collembola0.075_Site)
write.table (community_Collembola0.075_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.075_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.075_Site.txt")->community_Collembola0.075_Site
#
...
write.table (community_Collembola0.029, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.029.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.029.txt")->community_Collembola0.029
...
dim(community_Collembola0.029_Site)
write.table (community_Collembola0.029_Site, file="../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.029_Site.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../genetic/Data_out/Collembola/Collembola_IBD_Site/community_Collembola0.029_Site.txt")->community_Collembola0.029_Site
#
...
##**FORMAS DE OBTENER LA MATRIX GEO. La distancia está en metros**
##Nota_Nancy Es la matrix de Geodist hay que convertirla igual a la matrix de distancia
geomatrix_Site <- read.table("../spatial/IBDistanceMatrix/geomatrix_Site.txt",sep = ",", header=T, row.names = 1)
dim(geomatrix_Site)
class(geomatrix_Site)
geomatrix_Site <- as.matrix(geomatrix_Site)
class(geomatrix_Site)

geomatrix_Site[order(row.names(geomatrix_Site)),order(colnames(geomatrix_Site))]->geomatrix_Site #Ordena la geomatrix con la de beta. ##important order both matrixes

geomatrix_Site[upper.tri(geomatrix_Site)] <- NA 
geomatrix_Site
class(geomatrix_Site)

geomatrix_Site <- as.dist(geomatrix_Site) 
geomatrix_Site
#
...
plot(log_all_h_betasim, log_all_0.005_betasim, pch=20, main="log_all_forestCollembola_similarity_multilevel", col = "#cfebf3", ylim=c(-3.4,-0.05),xlim=c(-3.8,-0.1),ylab="log_similarity",xlab="log_similarity_h_level", cex.lab= 1.5, cex.axis= 1.5)
lines(estimated, counts.lineal_0.005,lwd=2, col = "#cfebf3", xlab = "Time (s)", ylab = "Counts")

points(log_all_h_betasim, log_all_0.015_betasim, pch=20, col="#66b2b2")
lines(estimated, counts.lineal_0.015,lwd=2, col = "#66b2b2", xlab = "Time (s)", ylab = "Counts")

points(log_all_h_betasim, log_all_0.02_betasim, pch=20, col="#27a397")
lines(estimated, counts.lineal_0.02,lwd=2, col = "#27a397", xlab = "Time (s)", ylab = "Counts")

points(log_all_h_betasim, log_all_0.029_betasim, pch=20, col="#2b72a6")
lines(estimated, counts.lineal_0.029,lwd=2, col="#2b72a6", xlab = "Time (s)", ylab = "Counts")

points(log_all_h_betasim, log_all_0.03_betasim, pch=20, col="#1d5686")
lines(estimated, counts.lineal_0.03,lwd=2, col = "#1d5686", xlab = "Time (s)", ylab = "Counts")

points(log_all_h_betasim, log_all_0.05_betasim, pch=20, col="#0a3056")
lines(estimated, counts.lineal_0.05,lwd=2, col = "#0a3056", xlab = "Time (s)", ylab = "Counts")

points(log_all_h_betasim, log_all_0.075_betasim, pch=20, col= "#FFCC33")
lines(estimated, counts.lineal_0.075,lwd=2, col = "#FFCC33", xlab = "Time (s)", ylab = "Counts")
#
##**Decay using geomatrix**
decay.model(all_h_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_h_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_h

decay.model(all_0.005_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_0.005_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_0.005

decay.model(all_0.015_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_0.015_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_0.015

decay.model(all_0.02_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_0.02_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_0.02

decay.model(all_0.03_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_0.03_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_0.03

decay.model(all_0.05_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_0.05_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_0.05

decay.model(all_0.075_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_0.075_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_0.075

decay.model(all_0.029_betasim,geomatrix_Site,model.type = "exp",y.type="sim")
decay.model(all_0.029_betasim,geomatrix_Site,model.type = "exp",y.type="sim")->decay_0.029
#
##**Plot all levels**
plot.decay(decay_h, ylim=c(0,1.0), pch=20, lwd=4, cex.lab= 1.5, cex.axis= 1.5, col="#000075")
...
##beta.pair_CollembolaSite_h
beta.multi(community_Collembola_h_Site, index.family="sorensen")->diss_mean_h
diss_mean_h$beta.SIM->diss_mean_h
beta.multi(community_Collembola0.005_Site, index.family="sorensen")->diss_mean_0.005
diss_mean_0.005$beta.SIM->diss_mean_0.005
beta.multi(community_Collembola0.015_Site, index.family="sorensen")->diss_mean_0.015
diss_mean_0.015$beta.SIM->diss_mean_0.015
beta.multi(community_Collembola0.02_Site, index.family="sorensen")->diss_mean_0.02
diss_mean_0.02$beta.SIM->diss_mean_0.02
beta.multi(community_Collembola0.03_Site, index.family="sorensen")->diss_mean_0.03
diss_mean_0.03$beta.SIM->diss_mean_0.03
beta.multi(community_Collembola0.05_Site, index.family="sorensen")->diss_mean_0.05
diss_mean_0.05$beta.SIM->diss_mean_0.05
beta.multi(community_Collembola0.075_Site, index.family="sorensen")->diss_mean_0.075
diss_mean_0.075$beta.SIM->diss_mean_0.075
beta.multi(community_Collembola0.029_Site, index.family="sorensen")->diss_mean_0.029
...
dim(community_Collembola_h_Site)[2]->n_h
dim(community_Collembola0.005_Site)[2]->n_0.005
dim(community_Collembola0.015_Site)[2]->n_0.015
dim(community_Collembola0.02_Site)[2]->n_0.02
dim(community_Collembola0.03_Site)[2]->n_0.03
dim(community_Collembola0.05_Site)[2]->n_0.05
dim(community_Collembola0.075_Site)[2]->n_0.075
dim(community_Collembola0.029_Site)[2]->n_0.029

rbind (n_h,n_0.005,n_0.015,n_0.02,n_0.03,n_0.05,n_0.075, n_0.029)->n_lineages
n_lineages

cor.test(log(levels),log(intercepts))
plot(log(intercepts)~log(levels), lwd=2, pch=16, cex=1.5, cex.lab= 1.5, cex.axis=1.5, col= c("#000075", "#cfebf3", "#66b2b2", "#27a397", "#2b72a6", "#1d5686", "#0a3056", "#FFCC33"))
abline(lm(log(intercepts)~log(levels)))

cor.test(log(levels),log(n_lineages))
plot(log(n_lineages)~log(levels), lwd=2, pch=16,cex=1.5, cex.lab= 1.5,  cex.axis= 1.5, col= c("#000075", "#cfebf3", "#66b2b2", "#27a397", "#2b72a6", "#1d5686", "#0a3056", "#FFCC33"))
abline(lm(log(n_lineages)~log(levels)))

cor.test(log(levels),log(mean_sim))
plot(log(mean_sim)~log(levels), lwd=2, pch=16,cex=1.5, cex.lab= 1.5,  cex.axis= 1.5, col= c("#000075", "#cfebf3", "#66b2b2", "#27a397", "#2b72a6", "#1d5686", "#0a3056", "#FFCC33"))
